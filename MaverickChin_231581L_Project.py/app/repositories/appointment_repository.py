...
class AppointmentLoad:
    ...
    CREATED_BY_PROFILE_WITH_PERSON = joinedload(Appointment.created_by).joinedload(
        Profile.person
    )
    CREATED_BY_PROFILE_WITH_POSSIBLE_PROFILES = (
        joinedload(Appointment.created_by).joinedload(Profile.doctor_profile),
        joinedload(Appointment.created_by).joinedload(Profile.receptionist_profile),
    )
...
class AppointmentRepository(BaseRepository[Appointment]):
    ...
    def list_appointment_details_by_patient_profile_id(
        self,
        session: Session,
        patient_profile_id: int,
        *,
